...
var CHARGERS_HEADERS = ['charger_id', 'name', 'max_minutes', 'slot_starts', 'active_session_id'];
...
var SESSIONS_ARCHIVE_HEADERS = SESSIONS_HEADERS.concat(['archived_at']);
...
var RESERVATIONS_ARCHIVE_HEADERS = RESERVATIONS_HEADERS.concat(['archived_at']);
...
function doGet(e) {
  var timing = createTiming_('doGet');
  ...
  var output = template.evaluate().setTitle(appName);
